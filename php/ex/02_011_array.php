<?php
// 인덱스 배열. (자동으로 주어짐.)변수값을 딱히 안주었기 때문에 인덱스(키라고 함)로 방만들어둠. 암꺼나 넣을 수 있음
...
// count() : 배열 혹은 그 외 것들의 사이즐 ㄹ반환하는 함수 >>제일 많이 씀.
...
//돌때 item은 저 값이 들어가는게 아니라 한 배열자체가 넘어옴.
